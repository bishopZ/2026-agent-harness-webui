# Accountability Wiki Index

Architecture map for the Accountability knowledge base. The Agent reads this first on every query to locate relevant pages. Updated on every ingest, query, update, and lint pass.
...
### `identity/` - Who Accountability Is
